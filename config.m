function [n, airy, div, D, nb_arms, arms_width, arms_width_lyot, nb_Mirrors, Diametre, Gap, Op, Ol, l, mask, pupil, lyot, based_on_pupil, spider_origin, hide_center_mirors] = config(i)
  ...
  based_on_pupil     = 1;           % 1 = reprends l'image de la pupille (segments de miroirs inclus), 0 = non
